# Brevet geometry — Thales, spoken English (classroom)

Hook. DE parallel to BC, AD/AB = 2/5. Students often answer AE/AC = 3/5, mixing leftover with whole side.

One idea. A line parallel to one side cuts the other two in the same ratio. Copy the same writing on both legs.
