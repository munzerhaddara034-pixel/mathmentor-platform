# Derivatives intro — spoken English (classroom)

Hook. Average speed from 1 to 2 is a slope between two points. That is not the speed at the instant t equals 1.

One idea. f'(a) is the limit of [f(a+h)−f(a)]/h. If that limit of slopes exists, it is the tangent slope.
