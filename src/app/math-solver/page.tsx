...
export default function MathSolverPage() {
  return (
    <main className="shell">
      ...
      <p className="muted">
        Text, LaTeX, or a photo of the notebook. The engine writes a Lebanese-curriculum solution, a HeyGen avatar script,
        and a time-synced math canvas. Instructor: <strong>Prof. Munzer Haddara / الأستاذ منذر حداره</strong>.
      </p>
