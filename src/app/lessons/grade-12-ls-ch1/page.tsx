...
export default function Grade12LsChapter1Page() {
  ...
  return (
    <SecurePlayerShell lessonId={GRADE_12_LS_LIMITS_LESSON_ID}>
      {({ watermark }) => (
        <main className="shell" dir="rtl">
          ...
          <article className="card" style={{ marginTop: 24 }}>
            ...
            <p className="muted">
              تدريب النهايات، أو مسابقة المسألة الرابعة (دراسة الدوال: نهاية، استمرار، مشتقة، جدول تغيرات، تقارب، دالة
              عكسية) مرتّبة سهل فمتوسط فصعب. البنود بأسلوب النماذج وليست نسخاً من دورة رسمية.
            </p>
            <div className="row">
